...
class R_Caller():
    ...
    def __init__(self, user_name, stats_option, assay_type, data_dir, analysis_id, graph, output_dir="./",):
        ...
        if assay_type == 'Paraflu':
            self.markdown_file = os.path.join(base_dir, 'pqresults', 'paraflu', 'PQReportCompiler4.Rmd')
    ...
    def execute(self, default=True, *args, **kwargs):
        ...
        if default:
            ...
            try:
                ...
                logs = self.__call_r_markdown(markdown_arg, self.output_dir, 
                                              user_arg, data_arg, stat_arg, assay_arg, 
                                              work_arg, limit_arg, analysis_id, graphing_type, lof_arg)
    ...
    def __call_r_markdown(self, markdown_file, output_dir, user_name, data_dir, 
                        ...
                        analysis_id, graphing_type, lof_file="nonspecified",):
